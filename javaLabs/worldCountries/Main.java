...
public class Main {
    public static void main(String[] args) {
        ...
        highestPopulatedCities.forEach(
                (countryCode, city) -> System.out.println("Country: " + countryCode + ", City: " + city.getName() +
        ...
        mostPopulatedCountries.forEach((continent, country) -> System.out
                .println("Continent: " + continent + ", Country: " + country.getName() +
